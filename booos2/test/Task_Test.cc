...
int main() {
	...
	cout << "Init" << Task_Test_Functions::test_init() << endl;
	cout << "Creation and Destruction" << Task_Test_Functions::test_creation_destruction() << endl;
	cout << "Cooperative execution" << Task_Test_Functions::test_cooperative_execution() << endl;
